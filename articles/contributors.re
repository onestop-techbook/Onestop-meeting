...
//embed{
    ...
    \hspace{1ex}
//}
ITエンジニア向けコミュニティー『エンジニアの登壇を応援する会』を立ち上げ活動中です。
コミュニティーを通じてアウトプットを促進するようなイベントを毎月開催しています。
この本をもってアウトプットに興味を持たれた方は、ぜひ遊びにきてください！
...
growthfactionやengineers_ltでは、広報担当としてコミュニティーの認知向上をするために日夜努力しております。
...
今回はこちら以外にも合同誌ふたつ書いています。Growthfactionの『挫折論への招待』もよろしくお願いします。
...
//embed{
    ...
    \hspace{1ex}
//}
メーカ子会社勤務1年目。勉強会に参加し、モチベーションと社外の情報を得ています。業務はC#でwindowsアプリを作っています。何かにつながると信じて、いろいろなことに挑戦中。
...
//embed{
    \begin{minipage}{.1\linewidth}
        \centering
        \includegraphics[width=.75\linewidth]{images/contributors/sukimaro_400x400.jpg}
    \end{minipage}
    \begin{minipage}{.89\linewidth}
        コバラスキマロ @kobarasukimaro https://twitter.com/kobarasukimaro
        \end{minipage}
    \hspace{1ex}
//}
とある機械翻訳開発会社で働くピアノとキャンプが好きな文系ソフトウェアエンジニアです。
...
//embed{
    ...
    \hspace{1ex}
//}
自分の本の〆切りが辛すぎて、余裕を持って執筆する技術が知りたいです。
技術書典6の「Kuinプログラミング入門」と、インプレス R&Dから刊行予定の「レベルアップPHP」をよろしくお願いします。
本が書き終わったら落ち着くので、勉強会でも登壇したいです。
